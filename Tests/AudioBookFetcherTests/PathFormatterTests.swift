...
final class PathFormatterTests: XCTestCase {
    func testBasePath() {
        let book = AudioBook(title: "title", authors: ["author1", "author2"], description: "description", chapters: [], coverURL: URL(fileURLWithPath: ""), content: .m3u8(URL(fileURLWithPath: "")), bookUrl: URL(fileURLWithPath: ""), genre: [], series: nil)
